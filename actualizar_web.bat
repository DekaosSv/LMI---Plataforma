...
git add data.js app.js index.html style.css process_lmi_excel.py *.xlsx "Logos Equipos" "Imagenes" "Sala de campeones" "Balon de oro" gestor_clubes.py gestor_clubes.bat
